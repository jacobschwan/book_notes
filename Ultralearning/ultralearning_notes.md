---
title: "Ultralearning"
subtitle: "Master Hard Skills, Outsmart the Competition, and Accelerate Your Career"
...
Start by learning how to learn the subject or skill you want to tackle. Discover how to do good research and how to draw on your past competencies to learn new skills.

**Determine What, Why, and How**

**Why**: Know why you want to learning

- Instrumental vs. intrinsic projects
- Tactic: Expert Interview - good for vetting instrumental projects

**What**: Deciding what to learn
Brainstorm all the things you need to learn for your project, then underline which will be most challenging.

Concept
: Ideas that you need to understand in flexible ways in order for them to be useful

Facts
: Anything that suffices if you can remember them at all

Procedures
: Actions that need to be performed and may not involve much conscious thinking at all

**How**: Your plan for learning

Benchmarking
: Identify resources that others have used to learn the same subject. Online courses, textbook lists, expert interviews, etc. Find the default curriculum.

Emphasize/Exclude Method
: First, find areas of study that align with the goals you identified in the first part of your research. Second, omit or delay elements of your benchmarked curriculum that don't align with your goals.
...
Testing isn't simply a  way of assessing knowledge but a way of creating it. Test yourself to actively recall information rather than passively review it.
...
All of these principles are only starting points. True mastery comes not just form following the path trodden by others but from exploring possibilities they haven't yet imagined.
